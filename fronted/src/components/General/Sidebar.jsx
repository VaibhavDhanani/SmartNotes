import { Home, Menu, Share2, Star, X } from "lucide-react";
...
const Sidebar = ({ activeMenu, setActiveMenu }) => {
  ...
  const menuItems = [
    ...
    { icon: <Star size={20} />, label: "Starred", path: "/workspace/stared" },
  ];

  return (
    <div
      className={`bg-gray-100 border-r border-gray-200 h-full flex flex-col ${
        collapsed ? "w-16" : "w-72"
